...
// Acesse: https://ganteartesanal.com.br/orlandia/api/setup.php?token=gante2026setup
//
...
try {
    ...
    // Garantir que a coluna type aceita qualquer valor (VARCHAR ao inves de ENUM)
    try {
    ...
    // Garantir que a coluna type aceita qualquer valor
    try {
