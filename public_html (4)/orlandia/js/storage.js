...
//
// ENDPOINTS:
//   - /orlandia/api/products.php    (GET, POST, PUT, DELETE)
//   - /orlandia/api/categories.php  (GET, POST, PUT, DELETE)
//   - /orlandia/api/extras.php      (GET - gelato_sizes, chocolate_boxes, toppings)

// Base URL do site (para imagens absolutas)
const SITE_BASE_URL = 'https://ganteartesanal.com.br/orlandia';
