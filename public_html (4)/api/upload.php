...
function handleUpload() {
    ...
    // Retornar sucesso com caminho relativo
    jsonResponse([
        'success' => true,
        'filename' => $newFilename,
        'path' => 'images/produtos/' . $newFilename,
        'url' => 'https://ganteartesanal.com.br/images/produtos/' . $newFilename,
        'size' => $file['size'],
        'type' => $imageInfo['mime'],
    ], 201);
}
...
function handleList() {
    ...
    foreach ($iterator as $fileInfo) {
        ...
        $files[] = [
            ...
            'url' => 'https://ganteartesanal.com.br/images/produtos/' . $fileInfo->getFilename(),
