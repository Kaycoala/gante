<?php
// ============================================
// GANTE SUMARE — Setup: Criar Tabelas e Seed de Dados
// ============================================
//
// Execute este script UMA VEZ para configurar o banco.
// Acesse: https://ganteartesanal.com.br/sumare/api/setup.php?token=gante2026setup
//
...
try {
    ...
    $results[] = '9 categorias inseridas.';
    ...
    jsonResponse([
        'success' => true,
        'message' => 'Setup Sumare concluido com sucesso!',
        'details' => $results,
    ]);
