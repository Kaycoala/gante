...
function handleUpload() {
    ...
    // Retornar sucesso com caminho relativo (para filial Sumare)
    jsonResponse([
        'success' => true,
        'filename' => $newFilename,
        'path' => 'images/produtos/' . $newFilename,
        'url' => 'https://ganteartesanal.com.br/sumare/images/produtos/' . $newFilename,
        'size' => $file['size'],
        'type' => $imageInfo['mime'],
    ], 201);
}
...
function handleList() {
    ...
    foreach ($iterator as $fileInfo) {
        ...
        $files[] = [
            ...
            'url' => 'https://ganteartesanal.com.br/sumare/images/produtos/' . $fileInfo->getFilename(),
