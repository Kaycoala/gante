// ============================================
// GANTE SUMARE — CRUD Helpers (PHP/MySQL API)
// ============================================
//
...
//
// ENDPOINTS:
//   - /sumare/api/products.php    (GET, POST, PUT, DELETE)
//   - /sumare/api/categories.php  (GET, POST, PUT, DELETE)
//   - /sumare/api/extras.php      (GET - gelato_sizes, chocolate_boxes, toppings)

// Base URL do site (para imagens absolutas)
const SITE_BASE_URL = 'https://ganteartesanal.com.br/sumare';

const API_BASE = '/sumare/api';
